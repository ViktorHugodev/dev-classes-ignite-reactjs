...
export type GetAllLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', availableAt?: any | null, id: string, lessonType: LessonType, slug: string, title: string }> };
